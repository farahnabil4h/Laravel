...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
   ...
   <div>
   <button class="w3-button w3-round w3-right w3-blue w3-margin" onclick="document.getElementById('newitem').style.display='block';return false;">
    New Item</button>
   <div class="w3-padding"style='max-width:600px;margin:auto' >
        <table class="w3-table w3-striped w3-bordered">
            <thead>
                <th>No</th><th>ID</th><th>Name</th><th>Price</th><th>Type</th><th>Quantity</th>
            </thead>
